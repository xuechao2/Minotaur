...
pid3="$!"
$binary_path -vv --p2p 127.0.0.1:6003 --api 127.0.0.1:7003 -c 127.0.0.1:6002  --sk c9afa9d845ba75166b5c215767b1d6934e50c3db36e89b127b8a622b120fb342 --ts "$time" &> local_node_4.log &
pid4="$!"
...
curl -s http://127.0.0.1:7003/tx-generator/start?theta=10000 > /dev/null
curl -s http://127.0.0.1:7003/miner/start?lambda=500 > /dev/null
curl -s http://127.0.0.1:7003/staker/start?zeta=100 > /dev/null
